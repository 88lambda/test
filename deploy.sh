...
echo -e $appcenterctl new-version $username $passfile $ucsver/$app_name $ucsver/$app_name=$app_ver

file_list=$(ls)

$appcenterctl upload $username $passfile --noninteractive $ucsver/$app_name=$app_ver $file_list 
